...
test_images, test_ids = dataset.read_test_sets(test_path, img_size,classes)
...
layer_flat = create_flatten_layer(layer_conv1,name="flatten")
...
filename="./summary_log/run" + "7layer"
...
def train(num_iteration):
    ...
    for i in range(total_iterations,total_iterations + num_iteration):
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, '7-layer-model') 


    total_iterations += num_iteration


train(num_iteration=30000) ## 5000 - 125 images - 34 epochs - 34 accuracy
